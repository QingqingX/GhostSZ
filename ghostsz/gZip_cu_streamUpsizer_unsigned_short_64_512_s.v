...
module gZip_cu_streamUpsizer_unsigned_short_64_512_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] tmp_3_fu_201_p1;
reg   [31:0] tmp_3_reg_430;
reg    ap_block_state3;
...
reg    ap_block_state7;
wire   [511:0] tmp_V_2_fu_197_p1;
wire   [511:0] tmp_V_4_fu_348_p1;
reg    ap_block_pp0_stage0_01001;
wire   [511:0] tmp_V_5_fu_388_p1;
wire   [511:0] tmp_V_6_fu_393_p1;
...
wire   [15:0] tmp_s_fu_167_p2;
wire   [9:0] tmp_8_fu_173_p4;
wire   [16:0] tmp_3_cast_fu_204_p1;
wire   [16:0] tmp_4_fu_207_p2;
wire   [13:0] tmp_6_fu_213_p4;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state4) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if ((~((tmp_1_reg_426 == 1'd0) & (outStream_V_V_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((inStream_V_V_empty_n == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        tmp_1_reg_426 <= tmp_1_fu_191_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~((tmp_1_reg_426 == 1'd0) & (outStream_V_V_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state3))) begin
        p_cast_reg_436[16 : 3] <= p_cast_fu_231_p1[16 : 3];
        tmp_3_reg_430[15 : 0] <= tmp_3_fu_201_p1[15 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_10_reg_441 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_V_3_reg_460 <= inStream_V_V_dout;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state9) | (1'b1 == ap_CS_fsm_state8) | ((tmp_2_fu_382_p2 == 1'd0) & (phitmp_fu_377_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state7)) | ((tmp_1_reg_426 == 1'd0) & (1'b1 == ap_CS_fsm_state3)) | ((icmp_reg_470 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
always @ (*) begin
    if (((outStream_V_V_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state9))) begin
        ...
        outStream_V_V_din = tmp_V_6_fu_393_p1;
    end else if ((~((outStream_V_V_full_n == 1'b0) & (ap_predicate_op82_write_state7 == 1'b1)) & (ap_predicate_op82_write_state7 == 1'b1) & (1'b1 == ap_CS_fsm_state7))) begin
        outStream_V_V_din = tmp_V_5_fu_388_p1;
    end else if (((icmp_reg_470 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_01001))) begin
        outStream_V_V_din = tmp_V_4_fu_348_p1;
    end else if ((~((tmp_1_reg_426 == 1'd0) & (outStream_V_V_full_n == 1'b0)) & (tmp_1_reg_426 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        outStream_V_V_din = tmp_V_2_fu_197_p1;
    end else begin
...
always @ (*) begin
    if ((((outStream_V_V_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state9)) | ((outStream_V_V_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state8)) | (~((outStream_V_V_full_n == 1'b0) & (ap_predicate_op82_write_state7 == 1'b1)) & (ap_predicate_op82_write_state7 == 1'b1) & (1'b1 == ap_CS_fsm_state7)) | ((icmp_reg_470 == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001)) | (~((tmp_1_reg_426 == 1'd0) & (outStream_V_V_full_n == 1'b0)) & (tmp_1_reg_426 == 1'd0) & (1'b1 == ap_CS_fsm_state3)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state7 : begin
            if ((~((outStream_V_V_full_n == 1'b0) & (ap_predicate_op82_write_state7 == 1'b1)) & (tmp_2_fu_382_p2 == 1'd1) & (phitmp_fu_377_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state7))) begin
                ap_NS_fsm = ap_ST_fsm_state9;
            end else if ((~((outStream_V_V_full_n == 1'b0) & (ap_predicate_op82_write_state7 == 1'b1)) & (tmp_2_fu_382_p2 == 1'd0) & (phitmp_fu_377_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state7))) begin
...
always @ (*) begin
    ap_block_state3 = ((tmp_1_reg_426 == 1'd0) & (outStream_V_V_full_n == 1'b0));
end
...
assign ap_int_blocking_cur_n = (outStream_V_V_blk_n & inStream_V_V_blk_n);

assign ap_int_blocking_n = (ap_int_blocking_cur_n & 1'b1);

always @ (*) begin
    ap_predicate_op82_write_state7 = ((tmp_2_fu_382_p2 == 1'd0) & (phitmp_fu_377_p2 == 1'd0));
end
...
assign chunk_size_fu_251_p2 = (tmp_3_reg_430 - ap_phi_mux_i_phi_fu_136_p4);
...
assign outSize_fu_183_p3 = {{tmp_8_fu_173_p4}, {6'd0}};

assign p_Result_s_fu_342_p2 = (tmp_18_fu_336_p2 | tmp_16_fu_327_p2);

assign p_cast_fu_231_p1 = tmp_9_fu_223_p3;

assign p_s_fu_256_p3 = ((tmp_5_reg_450[0:0] === 1'b1) ? chunk_size_reg_455 : 32'd8);
...
assign tmp_17_fu_333_p1 = tmp_V_3_reg_460;

assign tmp_18_fu_336_p2 = tmp_17_fu_333_p1 << tmp_13_fu_311_p1;

assign tmp_1_fu_191_p2 = ((outSize_fu_183_p3 == 16'd0) ? 1'b1 : 1'b0);

assign tmp_20_fu_272_p4 = {{byteIdx_fu_266_p2[31:6]}};

assign tmp_2_fu_382_p2 = ((val_assign_1_fu_110 == 32'd0) ? 1'b1 : 1'b0);

assign tmp_3_cast_fu_204_p1 = size_reg_414;

assign tmp_3_fu_201_p1 = size_reg_414;

assign tmp_4_fu_207_p2 = (tmp_3_cast_fu_204_p1 + 17'd7);

assign tmp_5_fu_246_p2 = (($signed(i_1_fu_240_p2) > $signed(tmp_3_reg_430)) ? 1'b1 : 1'b0);

assign tmp_6_fu_213_p4 = {{tmp_4_fu_207_p2[16:3]}};

assign tmp_8_fu_173_p4 = {{tmp_s_fu_167_p2[15:6]}};

assign tmp_9_fu_223_p3 = {{tmp_6_fu_213_p4}, {3'd0}};

assign tmp_V_2_fu_197_p1 = outSize_reg_421;

assign tmp_V_4_fu_348_p1 = p_Result_s_fu_342_p2[511:0];

assign tmp_V_5_fu_388_p1 = val_assign_1_fu_110;

assign tmp_V_6_fu_393_p1 = p_Val2_s_fu_114[511:0];

assign tmp_fu_163_p1 = val_assign_1_fu_110[15:0];

assign tmp_s_fu_167_p2 = (size_fu_159_p1 + tmp_fu_163_p1);

always @ (posedge ap_clk) begin
    outSize_reg_421[5:0] <= 6'b000000;
    tmp_3_reg_430[31:16] <= 16'b0000000000000000;
    p_cast_reg_436[2:0] <= 3'b000;
    p_cast_reg_436[31:17] <= 15'b000000000000000;
end

endmodule //gZip_cu_streamUpsizer_unsigned_short_64_512_s
