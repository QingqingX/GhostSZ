// ==============================================================
// File generated on Fri Apr 26 14:37:05 UTC 2019
...
// ==============================================================
`timescale 1ns/1ps
module gZip_cu_gZip_cu_control_s_axi
#(parameter
...
// 0x24 : reserved
// 0x28 : Data signal of encoded_size
//        bit 31~0 - encoded_size[31:0] (Read/Write)
// 0x2c : Data signal of encoded_size
//        bit 31~0 - encoded_size[63:32] (Read/Write)
// 0x30 : reserved
...
localparam
    ...
    ADDR_IN_V_CTRL           = 6'h18,
    ADDR_OUT_V_DATA_0        = 6'h1c,
    ADDR_OUT_V_DATA_1        = 6'h20,
    ADDR_OUT_V_CTRL          = 6'h24,
    ADDR_ENCODED_SIZE_DATA_0 = 6'h28,
    ADDR_ENCODED_SIZE_DATA_1 = 6'h2c,
    ADDR_ENCODED_SIZE_CTRL   = 6'h30,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_ENCODED_SIZE_DATA_1: begin
                    rdata <= int_encoded_size[63:32];
                end
...
// int_encoded_size[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        int_encoded_size[63:32] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_ENCODED_SIZE_DATA_1)
            int_encoded_size[63:32] <= (WDATA[31:0] & wmask) | (int_encoded_size[63:32] & ~wmask);
    end
end
